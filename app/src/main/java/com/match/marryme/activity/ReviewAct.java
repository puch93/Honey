...
import com.match.marryme.adapters.list.ThanksListAdapter;
import com.match.marryme.databinding.ActivityThanksBinding;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_sendmail:
                ...
                email.putExtra(Intent.EXTRA_SUBJECT,"[결혼할래]");
                email.putExtra(Intent.EXTRA_TEXT,"가장 스마트한 결혼방법[결혼할래]!\n언제 어디서나 내가 설정한 정보를 통해 원하는 배우자를 찾아보세요!\n결혼할래 다운로드 링크\nhttps://play.google.com/store/apps/details?id=com.match.marryme");
                startActivity(email);
                break;
